...
const Inflation = () => {
	...
	const { setSearch, inflationValue, setDollarValue, setInflationFocus } =
		...
		<Form onSubmit={handleSubmit}>
			<Wrapper>
				...
				<Input
					...
					placeholder='0'
					value={+dollarInput}
					onChange={(e) => setDollarInput(+e.target.value)}></Input>
			</Wrapper>
			<Wrapper>
				<Label>Focus:</Label>
			...
			<Wrapper>
				...
				<InputDate
					type='month'
					value={startDate}
					onChange={(e) => setStartDate(e.target.value)}></InputDate>
			</Wrapper>
			<Wrapper>
